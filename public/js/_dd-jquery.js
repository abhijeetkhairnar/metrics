...
(function($, undefined) {
  $.widget('ui.dd', {
		...
		_load: function(pid){	
			var self = this;
				$.ajax({url: self.options.source,type: 'POST',async: false,data: {limit : self.options.limit , page : self.page++ , pid : pid , searchval : self.leftSearch , pagination : self.options.pagination },dataType: 'json',					
